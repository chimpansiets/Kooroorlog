...
/*   Updated: 2019/11/20 14:56:16 by svoort        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void		check_errors(t_error type, char *error_str)
{
	if (type == amount_args)
		...
		ft_putstr_fd("Error: champ name missing.\n", 2);
	else if (type == comment_missing)
		ft_putstr_fd("Error: champ comment missing.\n", 2);
	else if (type == instr_not_found)
